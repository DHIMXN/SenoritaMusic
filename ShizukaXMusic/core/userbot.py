...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Dhimam_Network")
                await self.one.join_chat("VishuMusicLogger")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("VishuMusicLogger")
                await self.two.join_chat("Dhimam_Network")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Dhimam_Network")
                await self.three.join_chat("VishuMusicLogger")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Dhimam_Network")
                await self.four.join_chat("VishuMusicLogger")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Dhimam_Network")
                await self.five.join_chat("VishuMusicLogger")
            except:
                pass
            assistants.append(5)
